...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 Updates 🤖', url='https://telegram.me/visualmovies1')
            ],
            [
                InlineKeyboardButton('🙆🏻 Help 🦾', url=f"https://t.me/{temp.U_NAME}?start=help"),
            ],[
            InlineKeyboardButton('Watch Tutorial', url='https://telegram.me/visualmovies1')
            ],
            [
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
             ...
             [
                InlineKeyboardButton(
                    "🦋 SUBSCRIBE YT Channel 🦋", url='https://telegram.me/visualmovies1'
                )
            ]
        ]
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.answer('♥️ Thank You Visual Movies ♥️')
