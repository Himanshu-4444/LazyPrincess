...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://t.me/visualmovies1'),
        ] 
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Love @visualmovies1 ♥️')
            else:
                await query.message.edit_text(
                    "I'm not connected to any groups!\nCheck /connections or connect to any groups",
                    quote=True
                )
                return await query.answer('♥️ Thank You Visual ♥️')
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🧞‍♀️ Search 🧐', url='https://t.me/visualmoviesbot'),
            InlineKeyboardButton('🔔 Updates 🤖', url='https://t.me/visualmovies1')
        ], [
            InlineKeyboardButton('🙆🏻 Help 🦾', callback_data='help'),
            InlineKeyboardButton('♥️ About ♥️', callback_data='about')
        ],[
            InlineKeyboardButton('Watch Tutorial', url='https://t.me/visualmovies1')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        await query.answer('♥️ Thank You Visual ♥️')
        ...
        try:
            btn = [[
                ...
                InlineKeyboardButton(text=f"⚡️ Learn Bot Making 🦋", url=f"https://t.me/visualmovies1")
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0,
	    ...
	    InlineKeyboardButton("♻️ sᴇɴᴅ ᴀʟʟ ♻️", callback_data=f"files#{key}"),
        ] 
    )
    if offset != "":
